public class Map {
    ...
    public void createMap() {
        ...
        room5.addEnemyToCurrentRoom(new Enemy("BigBoss", "Last man standing", 100, 25, new RangedWeapon("Magic Wand", "Tryllestøv bliver sendt mod dig", 35, 20)));
    ...
    RangedWeapon bigBossWeapon = (RangedWeapon) bigBoss.getWeapon();
